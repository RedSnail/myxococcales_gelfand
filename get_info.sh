...
dataformat tsv genome --package myxococcales_meta.zip --fields assminfo-level,assminfo-refseq-assm-accession,assmstats-total-sequence-len,organism-name,tax-id,annotinfo-name | sort -u >  myxococcales_info.tsv
